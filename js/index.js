...
function switchsound() {
    ...
    if (au.paused) {
        ...
        au.pause();
        ai.src = "img/music_note_big1.png";
    }
}
...
function playbksound() {
    ...
    sound_div.style.cssText = "position:fixed;left:30px;top:30px;z-index:50000;visibility:visible;";
    sound_div.onclick = switchsound;
    if (document.body.offsetWidth > 400) {
        bg_htm = "<img id='sound_image' width='30px' src='img/music_note_big.png'>";
        box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:10px;top:-80px'></div>";
    }
    else {
        bg_htm = "<img id='sound_image' width='30px' src='img/music_note_big.png'>";
        box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:10px;top:-80px'></div>";
